...
<html>
    ...
    <body style="background:linear-gradient(25deg, white,#CADEF2);">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <form action="/Strategies/index.htm" method="POST">
                                <div class="form-group">
                                    <label> ID Persona </label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder="Buscar por ID" name="txtIdPersona" aria-describedby="button-addon2"/>
                                     <div class="input-group-append">
                                        <input class="btn btn-outline-primary btn-block" type="submit" name="botton" value="Buscar" id="button-addon2"/>
                                     </div>
                                    </div>
                                </div>   
                            </form>
                        ...
                        <form:form modelAttribute="persona" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="submit" name="botton" value="Insertar" onclick="confirm('Realmente desea guardar?');"  class="btn btn-outline-primary btn-block"/>
                                </div>
                                <div class="col-md-4">
                                    <input type="submit" name="botton" value="Actualizar" onclick="confirm('Realmente desea actualizar?');"  class="btn btn-outline-success btn-block"/>
                                </div>
                                <div class="col-md-4">
                                    <input type="submit" name="botton" value="Eliminar" onclick="confirm('Realmente desea eliminar?');"  class="btn btn-outline-danger btn-block"/>
                                </div>
                            </div>
                        </form:form>
                        <!-- Formulario de Persona -->
        ...
        <br>
        <!-- Footer -->
        <div class="footer-copyright text-center " style="background-color: rgba(11, 23, 41 , 0.8); color: white" >
            <br> 
            © Copyright: &nbsp;&nbsp;&nbsp;
